...
export default function EveningTeaModal() {
        ...
        <Modal
          ...
          <Box
            sx={{
              ...style,
              width: "50vw",
              backgroundImage: `url("https://static.vecteezy.com/system/resources/previews/003/125/420/large_2x/electronic-pen-smartphone-book-coffee-mug-on-blue-background-free-photo.jpg")`,
